...
with DAG(
    ...
    gcs_bucket = Variable.get("gcs_bucket", default_var="airflow-project-akshay-dev")
    bq_project = Variable.get("bq_project", default_var="project-ba2061d0-ea1c-46c5-86e")
    ...
    batch_details = {
        ...
        "environment_config": {
            "execution_config": {
                "service_account": "825542595423-compute@developer.gserviceaccount.com",
